...
/// Configure the identity bridge in pallets/identity-bridge.
impl pallet_identity_bridge::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type WeightInfo = pallet_identity_bridge::weights::SubstrateWeight<Runtime>;
	type GovernanceOrigin = frame_system::EnsureRoot<AccountId>;
	type Currency = Balances;
	type IssuanceFee = frame_support::traits::ConstU128<{ 100 * MILLI_UNIT }>;
	type FeeReceiver = frame_support::traits::ConstU32<0>; // Treasury or specific account ID
}
